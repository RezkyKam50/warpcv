...
<div style="display: flex; align-items: center; gap: 30px;">
  ...
  <span style="align-self: flex-start;"><strong>Latency introduced:</strong> Host-device memory transfers + NumPy conversion overhead + CUDA runtime context switching</span>
</div>
...
<div style="display: flex; align-items: center; gap: 30px;">
  ...
  <span style="align-self: flex-start;"><strong>Latency introduced:</strong> 3 separate kernel launches + GPU must wait for each kernel to complete where memory is read/written 3 times instead of once</span>
</div>
